...
document.getElementById('opciones-barra').addEventListener('click', function(event) {
  event.preventDefault(); // Prevenir el comportamiento predeterminado del enlace
  document.getElementById('contenedor2-titulo2').scrollIntoView({ behavior: 'smooth' });
});


document.getElementById('opciones-barra2').addEventListener('click', function(event) {
  event.preventDefault(); // Prevenir el comportamiento predeterminado del enlace
  document.getElementById('contenedor2-titulo2').scrollIntoView({ behavior: 'smooth' });
});
...
document.getElementById('opciones-barra3').addEventListener('click', function(event) {
  event.preventDefault(); // Prevenir el comportamiento predeterminado del enlace
  document.getElementById('contenedor2-titulo2').scrollIntoView({ behavior: 'smooth' });
});
...
document.getElementById('botoncito2').addEventListener('click', function(event) {
  event.preventDefault(); // Prevenir el comportamiento predeterminado del enlace
  document.getElementById('contenedor5-descripcion').scrollIntoView({ behavior: 'smooth' });
});
